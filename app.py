...
st.write(" کے تحت اگر آپ کا نام ظاہر ہوتا ہے تو براہ کرم اے سی آفس جائیں تاکہ یہ جان سکیں کہ آیا آپ کی درخواست قبول ہوئی ہے یا نہیں۔ ") st.write( "PLRA Not Verified ")
st.write("میں اگر آپ کا نام آ جائے تو اس کا مطلب ہے کہ آپ کی درخواست زمین کی وراثتی مسائل کی وجہ سے مسترد ہو گئی ہے- پٹواری سے رابطہ کریں اور وراثت منتقل کریں۔۔") st.write( " kin.csv")
